---
description: You are building PulseWatch, a production-grade SaaS monitoring platform. Monorepo structure: /apps/web (React + Vite) and /apps/api (Node.js + Express). Package manager: pnpm.
---
